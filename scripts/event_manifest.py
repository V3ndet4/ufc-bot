...
def derived_paths(manifest: dict[str, object]) -> dict[str, Path]:
    ...
    return {
        ...
        "prop_model_walk_forward_predictions": root / "reports" / "prop_model_walk_forward_predictions.csv",
        "prop_model_market_accuracy": root / "reports" / "prop_model_market_accuracy.csv",
        "prop_model_family_accuracy": root / "reports" / "prop_model_family_accuracy.csv",
        "prop_walk_forward_market_accuracy": root / "reports" / "prop_walk_forward_market_accuracy.csv",
        "prop_walk_forward_family_accuracy": root / "reports" / "prop_walk_forward_family_accuracy.csv",
        ...
        "fighter_identity_report": root / "reports" / "fighter_identity_report.csv",
        "prop_odds_inventory": root / "reports" / "prop_odds_inventory.csv",
        "prop_clv_market_quality": root / "reports" / "prop_clv_market_quality.csv",
        "prop_market_readiness": root / "reports" / "prop_market_readiness.csv",
        "odds_movement_clv": root / "reports" / "odds_movement_clv.csv",
        "tracked_clv": root / "reports" / "tracked_clv.csv",
        "market_consensus": root / "reports" / "market_consensus.csv",
        "scheduled_snapshot_coverage": root / "reports" / "scheduled_snapshot_coverage.csv",
        "decision_model_report": root / "reports" / "decision_model_report.csv",
        "elo_ratings": root / "reports" / "elo_ratings.csv",
        "finish_hazard_report": root / "reports" / "finish_hazard_report.csv",
        "leakage_audit": root / "reports" / "leakage_audit.csv",
        "prediction_uncertainty": root / "reports" / "prediction_uncertainty.csv",
        "news_reliability": root / "reports" / "news_reliability.csv",
        "official_context_report": root / "reports" / "official_context_report.csv",
        "model_leaderboard": root / "reports" / "model_leaderboard.csv",
...
def manifest_status_rows(manifest: dict[str, object]) -> list[tuple[str, str]]:
    ...
    for label, path in [
        ...
        ("prop_model_walk_forward_predictions", paths["prop_model_walk_forward_predictions"]),
        ("prop_model_market_accuracy", paths["prop_model_market_accuracy"]),
        ("prop_model_family_accuracy", paths["prop_model_family_accuracy"]),
        ("prop_walk_forward_market_accuracy", paths["prop_walk_forward_market_accuracy"]),
        ("prop_walk_forward_family_accuracy", paths["prop_walk_forward_family_accuracy"]),
        ("prop_model_thresholds", paths["prop_model_thresholds"]),
        ("prop_odds_archive_summary", paths["prop_odds_archive_summary"]),
        ("fighter_identity_report", paths["fighter_identity_report"]),
        ("prop_odds_inventory", paths["prop_odds_inventory"]),
        ("prop_clv_market_quality", paths["prop_clv_market_quality"]),
        ("prop_market_readiness", paths["prop_market_readiness"]),
        ("odds_movement_clv", paths["odds_movement_clv"]),
        ("tracked_clv", paths["tracked_clv"]),
        ("market_consensus", paths["market_consensus"]),
        ("scheduled_snapshot_coverage", paths["scheduled_snapshot_coverage"]),
        ("decision_model_report", paths["decision_model_report"]),
        ("elo_ratings", paths["elo_ratings"]),
        ("finish_hazard_report", paths["finish_hazard_report"]),
        ("leakage_audit", paths["leakage_audit"]),
        ("prediction_uncertainty", paths["prediction_uncertainty"]),
        ("news_reliability", paths["news_reliability"]),
        ("official_context_report", paths["official_context_report"]),
        ("model_leaderboard", paths["model_leaderboard"]),
